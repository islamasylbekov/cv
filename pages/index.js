        ...
        <Container className={styles.container} maxWidth="lg">
          <Paper className={styles.paper} elevation={4}>
            <div className={styles.header}>
              <div>
                <Typography className={styles.title} variant={'h3'}>Тойчубек уулу Исламбек</Typography>
                <Typography className={styles.subTitle} variant={'h6'}>Java full-stack developer</Typography>
              </div>
            ...
            <Grid className={styles.gridContainer} container>
              <Grid item xs={4}>
                ...
                <Typography>
                  Начинающий веб-разработчик, хочу развиваться в направлении back-end. Front-end разработкой занимаюсь
